...
##VGA Connector
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { R[0] }]; #IO_L7P_T1_AD2P_35 Sch=R1
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS33 } [get_ports { R[1] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=R2
set_property -dict { PACKAGE_PIN J20   IOSTANDARD LVCMOS33 } [get_ports { R[2] }]; #IO_L17P_T2_AD5P_35 Sch=R3
set_property -dict { PACKAGE_PIN G20   IOSTANDARD LVCMOS33 } [get_ports { R[3] }]; #IO_L18N_T2_AD13N_35 Sch=R4
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { R[4] }]; #IO_L15P_T2_DQS_AD12P_35 Sch=R5
